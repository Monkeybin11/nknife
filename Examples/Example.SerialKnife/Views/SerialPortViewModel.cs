...
namespace NKnife.Channels.SerialKnife.Views
{
    public class SerialPortViewModel : ViewModelBase
    {
        ...
        private readonly SerialChannelService _ChannelService;

        public SerialPortViewModel(SerialChannelService channelService)
        {
        ...
        {
            get { return _RxCount; }
            set { Set(() => RxCount, ref _RxCount, value); }
        }

        public long TxCount
        {
            get { return _TxCount; }
            set { Set(() => TxCount, ref _TxCount, value); }
        }
