...
{
    public class SerialChannelService : IDictionary<ushort, Tuple<SerialConfig, SerialChannel>>
    {
        private readonly Dictionary<ushort, Tuple<SerialConfig, SerialChannel>> _Map =
            new Dictionary<ushort, Tuple<SerialConfig, SerialChannel>>(SerialUtils.LocalSerialPorts.Count);
        ...
        /// </summary>
        /// <returns>
        ///     如果该元素已成功移除，则为 true；否则为 false。如果在原始 <see cref="T:System.Collections.Generic.IDictionary`2" /> 中没有找到
        ///     <paramref name="key" />，该方法也会返回 false。
        /// </returns>
        ...
        /// <summary>
        ///     获取包含 <see cref="T:System.Collections.Generic.IDictionary`2" /> 的键的
        ///     <see cref="T:System.Collections.Generic.ICollection`1" />。
        /// </summary>
        /// <returns>
        ///     一个 <see cref="T:System.Collections.Generic.ICollection`1" />，它包含实现
        ///     <see cref="T:System.Collections.Generic.IDictionary`2" /> 的对象的键。
        /// </returns>
        ...
        public SerialChannel AddSerial(SerialConfig config)
        {
            ...
            serialChannel.Closed += (s, e) => { Remove(config.Port); };
            serialChannel.IsSynchronous = false;
            _Map.Add(config.Port, new Tuple<SerialConfig, SerialChannel>(config, serialChannel));
            OnChannelCountChanged();
        ...
        /// <exception cref="T:System.NotSupportedException"><see cref="T:System.Collections.Generic.IDictionary`2" /> 为只读。</exception>
        void IDictionary<ushort, Tuple<SerialConfig, SerialChannel>>.Add(ushort key, Tuple<SerialConfig, SerialChannel> value)
        {
            _Map.Add(key, value);
        }
        ...
        /// <exception cref="T:System.ArgumentNullException"><paramref name="key" /> 为 null。</exception>
        bool IDictionary<ushort, Tuple<SerialConfig, SerialChannel>>.TryGetValue(ushort key, out Tuple<SerialConfig, SerialChannel> value)
        {
        ...
        ///     设置该属性，而且 <see cref="T:System.Collections.Generic.IDictionary`2" />
        ///     为只读。
        /// </exception>
        Tuple<SerialConfig, SerialChannel> IDictionary<ushort, Tuple<SerialConfig, SerialChannel>>.this[ushort key]
        {
            get => _Map[key];
            set => _Map[key] = value;
        }
        ...
        /// <summary>
        ///     获取包含 <see cref="T:System.Collections.Generic.IDictionary`2" /> 中的值的
        ///     <see cref="T:System.Collections.Generic.ICollection`1" />。
        /// </summary>
        /// <returns>
        ///     一个 <see cref="T:System.Collections.Generic.ICollection`1" />，它包含实现
        ///     <see cref="T:System.Collections.Generic.IDictionary`2" /> 的对象中的值。
        /// </returns>
        ICollection<Tuple<SerialConfig, SerialChannel>> IDictionary<ushort, Tuple<SerialConfig, SerialChannel>>.Values => _Map.Values;
        ...
        /// </returns>
        public IEnumerator<KeyValuePair<ushort, Tuple<SerialConfig, SerialChannel>>> GetEnumerator()
        {
        ...
        /// <exception cref="T:System.NotSupportedException"><see cref="T:System.Collections.Generic.ICollection`1" /> 是只读的。</exception>
        void ICollection<KeyValuePair<ushort, Tuple<SerialConfig, SerialChannel>>>.Add(KeyValuePair<ushort, Tuple<SerialConfig, SerialChannel>> item)
        {
            _Map.Add(item);
        }
        ...
        bool ICollection<KeyValuePair<ushort, Tuple<SerialConfig, SerialChannel>>>.Contains(KeyValuePair<ushort, Tuple<SerialConfig, SerialChannel>> item)
        {
            var map = (IDictionary<ushort, Tuple<SerialConfig, SerialChannel>>) _Map;
        ...
        /// </exception>
        void ICollection<KeyValuePair<ushort, Tuple<SerialConfig, SerialChannel>>>.CopyTo(KeyValuePair<ushort, Tuple<SerialConfig, SerialChannel>>[] array, int arrayIndex)
        {
            var map = (IDictionary<ushort, Tuple<SerialConfig, SerialChannel>>) _Map;
        ...
        /// <exception cref="T:System.NotSupportedException"><see cref="T:System.Collections.Generic.ICollection`1" /> 是只读的。</exception>
        bool ICollection<KeyValuePair<ushort, Tuple<SerialConfig, SerialChannel>>>.Remove(KeyValuePair<ushort, Tuple<SerialConfig, SerialChannel>> item)
        {
            var map = (IDictionary<ushort, Tuple<SerialConfig, SerialChannel>>) _Map;
        ...
        /// </returns>
        bool ICollection<KeyValuePair<ushort, Tuple<SerialConfig, SerialChannel>>>.IsReadOnly
        {
            get
            {
                var map = (IDictionary<ushort, Tuple<SerialConfig, SerialChannel>>) _Map;
