    ...
    public sealed class LoggerInfoDetailForm : Form
    {
        ...
        private void FillLogInfo(LogEventInfo info)
        {
            ...
            switch (info.Level.Name)
            {
                ...
                case "Debug":
                case "Info":
                    _exInfoPage.Text = "Exception_TabName_Simple";//UtilityResource.GetString(StringResource.ResourceManager, "Exception_TabName_Simple");
                    break;
                case "Warn":
                case "Error":
                case "Fatal":
                default:
                    _exInfoPage.Text = "Exception_TabName_Error";//UtilityResource.GetString(StringResource.ResourceManager, "Exception_TabName_Error");
                    break;
            }
